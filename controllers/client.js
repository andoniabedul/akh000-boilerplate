                    ...
                    mkdirp(`./public/${client.name}/${project.name}`, (err)=>{
                      if(err) return res.render('error', {error: err})
                        ...
                        let phases = [
                          ...
                          `${path}/03.Ejecución/04.Transición`,
                          `${path}/03.Ejecución/04.Transición/Soporte`,
                          `${path}/03.Ejecución/04.Transición/Guias`,
                          `${path}/03.Ejecución/04.Transición/Capacitación`,
